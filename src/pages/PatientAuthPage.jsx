            ...
            <div className="p-7 flex flex-col gap-4">
              {mode === 'register' && (
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input className="input-field" name="name" placeholder="Алёна Иванова" value={form.name} onChange={handleChange} />
                  </div>
              )}

              <div className="flex flex-col gap-1.5">
                <label className="text-xs text-gray-500">Email</label>
                <input className="input-field" name="email" type="email" placeholder="patient@mail.ru" value={form.email} onChange={handleChange} />
              </div>
