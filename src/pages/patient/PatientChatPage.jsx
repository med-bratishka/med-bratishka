    ...
    return (
        <div className="flex flex-col h-screen">
            <div className="bg-white border-b border-gray-100 px-6 py-4">
                <p className="text-sm font-medium text-gray-800">Чат с врачом</p>
                <p className="text-xs text-gray-400">Подключитесь к врачу чтобы начать общение</p>
            </div>
            <div className="flex-1 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-xs text-gray-400">Чат появится после подключения к врачу</p>
                </div>
            </div>
